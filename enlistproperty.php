          ...
          <div class="row">
            <div class="col-md-12 col-lg-8">
              <div class="title-single-box">
                <h1 class="title-single">ENLIST PROPERTY</h1>
                <span class="color-text-a"
                  >It is absolutely free. Fill in the form below
                  and upload images of the property.</span
                >
              </div>
            </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <textarea
                            ...
                            cols="1"
                            rows="2"
                            placeholder="Do you have images of the property?"
                            required
                          ></textarea>
                        </div>
                      </div>
                      <div class="col-md-12 my-3">
                        <div class="mb-3">
                          ...
                          <div class="sent-message">
                            A find my Home agent will contact you shortly
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="socials-footer">
                          <ul class="list-inline">
                            <li class="list-inline-item">
                              <a href="https://facebook.com" class="link-one">
                                <i
                            ...
                            <li class="list-inline-item">
                              <a href="https://instagram.com" class="link-one">
                                <i
                            ...
                            <li class="list-inline-item">
                              <a href="https://linkedin.com" class="link-one">
                                <i
