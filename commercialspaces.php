          ...
          <div class="row">
            <div class="col-md-12 col-lg-8">
              <div class="title-single-box">
                <h1 class="title-single">COMMERCIAL SPACES</h1>
                <span class="color-text-a">OFFICES</span>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-1.jpg"
                    alt=""
                  ...
                  <div class="card-overlay-a-content">
                    ...
                    <div class="card-footer-a">
                      <ul class="card-info d-flex justify-content-around">
                        ...
                        <li>
                          <h4 class="card-info-title">Reception</h4>
                          <span>1</span>
                        </li>
                      </ul>
                    </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-2.jpg"
                    alt=""
                    class="img-a img-fluid"
                  />
                </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-3.jpg"
                    alt=""
                    class="img-a img-fluid"
                  />
                </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-4.jpg"
                    alt=""
                    class="img-a img-fluid"
                  />
                </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-5.jpg"
                    alt=""
                    class="img-a img-fluid"
                  />
                </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-6.jpg"
                    alt=""
                    class="img-a img-fluid"
                  />
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-7.jpg"
                    alt=""
                    class="img-a img-fluid"
                  />
                </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-9.jpg"
                    alt=""
                    class="img-a img-fluid"
                  />
                </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-11.jpg"
                    alt=""
                    class="img-a img-fluid"
                  />
                </div>
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-16.jpg"
                    alt=""
                    class="img-a img-fluid"
                  />
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img
                    src="assets/img/commspaces-14.jpg"
                    alt=""
                    class="img-a img-fluid"
                  />
                </div>
